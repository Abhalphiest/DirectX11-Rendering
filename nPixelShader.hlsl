...
float4 main(VertexToPixel input) : SV_TARGET
{
	...
	lightAmount = saturate(dot(toLight, mapNormal)); //already normalized
	...
	lightAmount = 1/dropoffRatio*saturate(dot(toLight, mapNormal)); //already normalized
	...
	return (lightCompute1
		+ lightCompute2
		+ lightCompute3)*textureColor + spec*specColor;
